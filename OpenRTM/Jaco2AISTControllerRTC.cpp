#include "Jaco2AISTControllerRTC.h"
#include <iostream>
#include <vector>
#include <fcntl.h>
...
static const char* Jaco2AISTControllerRTC_spec[] =
  {
    "implementation_id", "Jaco2AISTControllerRTC",
    "type_name",         "Jaco2AISTControllerRTC",
 ...
 */
Jaco2AISTControllerRTC::Jaco2AISTControllerRTC(RTC::Manager* manager)
...
Jaco2AISTControllerRTC::~Jaco2AISTControllerRTC()
{
}



RTC::ReturnCode_t Jaco2AISTControllerRTC::onInitialize()
{
    ...
    string modelfile = getNativePathString(
        boost::filesystem::path(shareDirectory()) / "model/AizuSpider/AizuSpiderDS.body");
...
RTC::ReturnCode_t Jaco2AISTControllerRTC::onActivated(RTC::UniqueId ec_id)
{
...
RTC::ReturnCode_t Jaco2AISTControllerRTC::onDeactivated(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}

// m_angle_L.data.length() が使用可能
RTC::ReturnCode_t Jaco2AISTControllerRTC::onExecute(RTC::UniqueId ec_id)
{
 ...
 RTC::ReturnCode_t Jaco2AISTControllerRTC::onError(RTC::UniqueId ec_id) 
{
   return RTC::RTC_OK;
}
...
extern "C"
{
  ...
  void Jaco2AISTControllerRTCInit(RTC::Manager* manager)
  {
    coil::Properties profile(Jaco2AISTControllerRTC_spec);
    manager->registerFactory(profile,
                             RTC::Create<Jaco2AISTControllerRTC>,
                             RTC::Delete<Jaco2AISTControllerRTC>);
  }
...
Matrix3d Jaco2AISTControllerRTC::RotateX(double radian){
...
Matrix3d Jaco2AISTControllerRTC::RotateY(double radian){
...
Matrix3d Jaco2AISTControllerRTC::RotateZ(double radian){
...
Vector3 Jaco2AISTControllerRTC::toRadianVector3(double x, double y, double z)
{
...
void Jaco2AISTControllerRTC::updateTargetJointAnglesBYInverseKinematicks()
{ 
...
double Jaco2AISTControllerRTC::deg2rad(double degree)
{
    return degree * M_PI / 180.0f;
}

double Jaco2AISTControllerRTC::rad2deg(double radian)
{
    return radian * 180.0f/ M_PI;
}

void Jaco2AISTControllerRTC::sequence(){
...
bool Jaco2AISTControllerRTC::perform(int seqNum){
...
int Jaco2AISTControllerRTC::updateControlflg()
{
